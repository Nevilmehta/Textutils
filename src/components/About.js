  ...
  return (
    <div className="container">
        ...
        <div className="accordion-item" style={myStyle}>
            ...
            If you receive huge amounts of unstructured data in the form of text (emails, social media conversations, chats), you’re probably aware of the challenges that come with analyzing this data.Manually processing and organizing text data takes time, it’s tedious, inaccurate, and it can be expensive if you need to hire extra staff to sort through text.            </div>
            </div>
        </div>
        <div className="accordion-item" style={myStyle}>
